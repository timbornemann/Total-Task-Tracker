    ...
    switch (code) {
      case 500:
        return {
          ...
          description:
            "Auf dem Server ist ein unerwarteter Fehler aufgetreten. Unser Team wurde benachrichtigt.",
        };
      case 502:
        return {
          title: "Bad Gateway",
          description:
            "Der Server ist vorübergehend nicht erreichbar. Bitte versuchen Sie es in wenigen Minuten erneut.",
        };
      case 503:
        return {
          title: "Service nicht verfügbar",
          description:
            "Der Service ist vorübergehend nicht verfügbar. Möglicherweise führen wir gerade Wartungsarbeiten durch.",
        };
      case 504:
        return {
          title: "Gateway Timeout",
          description:
            "Der Server antwortet nicht rechtzeitig. Bitte versuchen Sie es in wenigen Minuten erneut.",
        };
      default:
        return {
          title: "Server-Fehler",
      ...
      <Button
        ...
        onClick={() =>
          (window.location.href =
            "mailto:support@example.com?subject=Server Error Report")
        }
        className="w-full"
      >
