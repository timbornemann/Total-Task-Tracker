...
export const STATUS_TYPES = {
  ...
  'in-progress': { value: 'in-progress', label: 'In Bearbeitung', order: 2, color: 'blue' },
  completed: { value: 'completed', label: 'Erledigt', order: 3, color: 'green' },
  cancelled: { value: 'cancelled', label: 'Abgebrochen', order: 4, color: 'red' },
} as const;
