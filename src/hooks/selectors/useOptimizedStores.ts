...
export function useTasksByDateRange(store: TaskStoreState, start: Date, end: Date) {
  return useMemo(
...
export function useRecurringTaskById(store: RecurringTaskStoreState, taskId: string) {
  return useMemo(
...
export function useUpcomingRecurringTasks(store: RecurringTaskStoreState, hours: number = 24) {
  return useMemo(
    () => recurringTaskSelectors.getUpcomingRecurringTasks(store.recurringTasks, hours),
    [store.recurringTasks, hours]
  );
}

export function useRecurringTasksByCategory(store: RecurringTaskStoreState, categoryId: string) {
  return useMemo(
    () => recurringTaskSelectors.getRecurringTasksByCategory(store.recurringTasks, categoryId),
...
export function useTasksWithCategories(
  ...
  return useMemo(
    () => combinedSelectors.getTasksWithCategories(taskStore.allTasks, categoryStore.allCategories),
...
export function useNotesWithCategories(
  ...
  return useMemo(
    () => combinedSelectors.getNotesWithCategories(noteStore.allNotes, categoryStore.allCategories),
...
export function useDebouncedSelector<T, R>(
  ...
  const [debouncedResult, setDebouncedResult] = useState<R>(() => selector(state));
