...
export const allNavbarItems: NavbarItem[] = [
  ...
  { key: "kanban", group: "tasks", labelKey: "navbar.kanban", path: "/kanban" },
  {
    key: "schedule",
    group: "tasks",
    labelKey: "navbar.schedule",
    path: "/timeblocks",
  },
  {
    key: "recurring",
    group: "tasks",
    labelKey: "navbar.recurring",
    path: "/recurring",
  },
  ...
  },
  {
    key: "cards",
    group: "learning",
    labelKey: "navbar.cards",
    path: "/flashcards",
  },
  {
    key: "decks",
    group: "learning",
    labelKey: "navbar.decks",
    path: "/flashcards/manage",
  },
  {
    key: "pomodoro",
    group: "learning",
    labelKey: "navbar.pomodoro",
    path: "/pomodoro",
  },
  {
    key: "timers",
    group: "learning",
    labelKey: "navbar.timers",
    path: "/timers",
  },
  ...
  },
  {
    key: "worklogStats",
    group: "learning",
    labelKey: "navbar.worklogStats",
    path: "/worklog/stats",
  },
  {
    key: "cardStatistics",
    group: "learning",
    labelKey: "navbar.cardStatistics",
